Spinka::Application.routes.draw do
  ...
  resources :posts, path: '/posty', only: [:create, :edit, :update, :destroy], path_names: { edit: 'edycja' }

  resources :topics, path: '/forum', only: [:new, :create, :show, :edit, :destroy, :update], path_names: { new: 'nowy', edit: 'edycja' }

  resources :categories, path: '/kategorie', only: [:new, :create, :edit, :show, :update, :destroy], path_names: { new: 'nowa', edit: 'edycja' } do
  end
